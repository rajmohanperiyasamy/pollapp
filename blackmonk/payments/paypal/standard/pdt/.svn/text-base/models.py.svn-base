...
from payments.paypal.standard.models import PayPalStandardBase
from payments.paypal.standard.conf import POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT
from payments.paypal.standard.pdt.signals import pdt_successful, pdt_failed
...
class PayPalPDT(PayPalStandardBase):
    ...
    def _postback(self):
        ...
        """
        #common_conf = CommonConfigure.objects.only('paypal_identity_token')[:1][0]
        #IDENTITY_TOKEN = common_conf.paypal_identity_token #'QLe1Zqi2D1Egg3RXDRwDrsMT0uKRU6SoED_DmRrEIYpXaZbK3RMkot7xGtG' #common_conf.paypal_identity_token # 'OVlVsScFzrcwJS0NSNIbngnXW2jLW7_3NF7wkahL2ZHTpoTgd8fYXT_OazO'
        
        IDENTITY_TOKEN='QLe1Zqi2D1Egg3RXDRwDrsMT0uKRU6SoED_DmRrEIYpXaZbK3RMkot7xGtG'        
