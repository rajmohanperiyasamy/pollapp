...
from payments.authorizenet import AUTHNET_CIM_URL, AUTHNET_TEST_CIM_URL
from payments.authorizenet.models import CIMResponse, Response
from payments.authorizenet.signals import customer_was_created, customer_was_flagged, \
...
class BaseRequest(object):
    ...
    def create_base_document(self, action):
        ...
        name = self.get_text_node("name", payment_config.login_id)
        key = self.get_text_node("transactionKey",
                                 payment_config.transaction_key)
