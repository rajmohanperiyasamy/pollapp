...
def get_analytics_data():
    ...
    #for i in range(1,61):
        ...
        visit_duration=datetime.timedelta(hours=00, minutes=00, seconds=01)
        for rd in rdata:
        ...
        visit_duration=str(visit_duration.hour)+":"+str(visit_duration.minute)+":"+str(visit_duration.second)
...
@celery.task(name='tasks.process_analytics_data')
