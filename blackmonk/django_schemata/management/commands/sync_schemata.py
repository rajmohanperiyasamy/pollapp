...
class BaseSchemataCommand(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for domain_name in settings.SCHEMATA_DOMAINS:
            ...
            #settings.DJAPIAN_DATABASE_PATH=os.path.join( '/home/shabeer/localengine/bm/blackmonk/xapian_index',domain_name)
            #settings.HAYSTACK_CONNECTIONS['default']['PATH'] =os.path.join( '/home/shabeer/localengine/bm/blackmonk/xapian_index',domain_name)# {'default': {'ENGINE': 'haystack.backends.xapian_backend.XapianEngine','PATH': os.path.join( '/home/shabeer/localengine/bm/blackmonk/xapian_index',domain_name), },}
            settings.HAYSTACK_CONNECTIONS['default']['PATH'] =os.path.join( '/home/blackmonk/webapps/xapian_index',domain_name)
